...
class Test{
	...
	public static void main(String [] args){
		...
		String s =map.get(new User("alex",18));//此时新传入的user对象和之前生成的u1对象用equals函数判断是相同的，
											   ...
											   //但是实际上不复写hashcode方法取出来的是 null
											   //原因是map的get方法是通过hashcode方法得到的哈希值来判断user对象是否在map中存在
											   //Object默认的map的hashcode方法对不同的对象生成了不同的哈希值，因此找不到为null	
											   //所以我们要复写对象的hashcode方法，使得相同对象的hashcode方法返回值相同
